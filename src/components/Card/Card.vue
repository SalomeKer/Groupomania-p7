...
<template>
<div class="card w-100 shadow-lg border border-white mt-5" style="border-radius: 1rem;">
    <div class="card-header" style="border-top-left-radius: 1rem;border-top-right-radius: 1rem;"><img src="3.png" class="rounded-circle me-3" style="width: 70px; height: 70px;" alt="Avatar" />Pierre Dupont</div>
		<div class="card-body">
			<img class="card-img-top" src="groupe.jpg" alt="Card image cap">
            <div class="card-body">
